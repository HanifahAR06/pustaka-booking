<!-- login modal --> <div class="modal fade" tabindex="-1" id="loginModal" role="dialog">     
            ...
            <form action="<?= base_url('member/daftar'); ?>" method="post">                 
            	<div class="modal-body">                     
            		<div class="form-group">                         
            			<input type="text" class="form-control form-controluser" id="nama" name="nama" placeholder="Nama Lengkap">                     </div>                     
            			<div class="form-group">                         
