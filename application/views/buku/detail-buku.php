 <div class="x_panel" align="center"> 
    ...
    <div class="x_content">       
        ...
        <p>                 
        	<a class="btn btn-outline-primary fas fw fa-shoppingcart" href="<?= base_url('booking/tambahBooking/' . $id); ?>"> Booking</a>                 <span class="btn btn-outline-secondary fas fw fareply" onclick="window.history.go(-1)"> Kembali</span>               
        </p>             
    </div>           
</div>         
</div>       
